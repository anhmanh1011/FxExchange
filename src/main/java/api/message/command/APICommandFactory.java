...
import api.message.codes.PERIOD_CODE;
...
import api.message.records.ChartLastInfoRecord;
import api.message.records.ChartRangeInfoRecord;
...
import api.message.response.AllSymbolsResponse;
import api.message.response.CalendarResponse;
import api.message.response.ChartResponse;
import api.message.response.CommissionDefResponse;
import api.message.response.CurrentUserDataResponse;
import api.message.response.IbsHistoryResponse;
import api.message.response.LoginResponse;
import api.message.response.LogoutResponse;
import api.message.response.MarginLevelResponse;
import api.message.response.MarginTradeResponse;
import api.message.response.NewsResponse;
import api.message.response.PingResponse;
import api.message.response.ProfitCalculationResponse;
import api.message.response.ServerTimeResponse;
import api.message.response.StepRulesResponse;
...
import api.message.response.TradeTransactionStatusResponse;
import api.message.response.TradesHistoryResponse;
import api.message.response.TradesResponse;
import api.message.response.TradingHoursResponse;
import api.message.response.VersionResponse;
...
public class APICommandFactory {
    ...
    @SuppressWarnings("unchecked")
    public static TickPricesCommand createTickPricesCommand(Long level, String symbols, Long timestamp) throws APICommandConstructionException {
        JSONObject args = new JSONObject();
...
//        arr.put(symbols);
    ...
    public static TickPricesResponse executeTickPricesCommand(SyncAPIConnector connector, Long level, String symbols, Long timestamp) throws APICommandConstructionException, APICommunicationException, APIReplyParseException, APIErrorResponse {
